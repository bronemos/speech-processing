...
vad_perceptron = None  # VAD Classification of the utterance based on the trained perceptron model with vad_input as the input matrix
error_perceptron = None  # Classification error
print("Error of perceptron: " + str(error_perceptron))

thresh_linear = 0.0
vad_linear = None  # VAD Classification of the utterance based on the linear model with vad_input as the input matrix
error_linear = None  # Classification error
